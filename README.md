...
> 完整文档请访问 **[DataMind-Doc](https://github.com/your-org/DataMind-Doc)** — 包含各模块详细说明、数据格式规范、演示指南和 Benchmark 使用指南。
...
| 模块 | 功能 | 详细文档 |
|------|------|---------|
| **RAG** | 文档向量化 + 语义检索，支持多模态 (CLIP / VLM) | [RAG 文档](https://github.com/your-org/DataMind-Doc) |
| **GraphRAG** | 知识图谱实体关系检索，多跳推理 | [GraphRAG 文档](https://github.com/your-org/DataMind-Doc) |
| **Database** | 自然语言转 SQL，支持 SQL 文件自动导入 | [Database 文档](https://github.com/your-org/DataMind-Doc) |
| **Skills** | 工具型（Python 函数）+ 知识型（Markdown 检索） | [Skills 文档](https://github.com/your-org/DataMind-Doc) |
| **Memory** | FIFO 短期记忆 + LLM 摘要长期记忆 | [Memory 文档](https://github.com/your-org/DataMind-Doc) |
...
详细的数据格式规范请参阅 [数据格式文档](https://github.com/your-org/DataMind-Doc)。
...
详见 [Benchmark 文档](https://github.com/your-org/DataMind-Doc)。
